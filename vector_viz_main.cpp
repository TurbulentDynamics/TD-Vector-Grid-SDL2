...
// this method is use to return Yaml resource 




// yaml file inputs definttions
...
// end of yaml file definitions

// yaml file outpus definitions
...
char* getYamlSource(int argc, char **argv)
{
...
void setPInputAndOutPutNode(char *yamlSource, Sip::YAMLDocumentUTF8::Node *pInputNode, Sip::YAMLDocumentUTF8::Node *pOutputNode)
{
...
int getInputsFromPinputNode(std::pair<char const*, char**> inParameters[])
{
...
void getOutPutParameters(std::pair<char const*, char**> outParameters[], std::pair<char const*, bool*> flags[], std::pair<char const *, Sip::YAMLDocumentUTF8::Node**> subNodes[])
{
...
void setOrientations(Orientation orientations[])
{
...
void overrideOption(int argc, char **argv)
{
...
int main(int argc, char **argv)
{
	...
	return CheckArgc(argc); 
	char* yamlSource = getYamlSource(argc, argv);
	Sip::YAMLDocumentUTF8::Node *pInputNode;
	Sip::YAMLDocumentUTF8::Node *pOutputNode;
	setPInputAndOutPutNode(yamlSource, pInputNode, pOutputNode);
	std::pair<char const*, char**> inParameters[];
	return getInputsFromPinputNode(inParameters);
	...
	std::pair<char const*, bool*> flags[];
	std::pair<char const *, Sip::YAMLDocumentUTF8::Node**> subNodes[];
	getOutPutParameters(outParameters[], flags[], subNodes[]);
